...
copy %QT_LIB_DIR%\Qt5Core.dll %BUILD_OUTPUT_DIR%
copy %QT_LIB_DIR%\Qt5Gui.dll %BUILD_OUTPUT_DIR%
copy %QT_LIB_DIR%\Qt5Widgets.dll %BUILD_OUTPUT_DIR%
copy %QT_LIB_DIR%\Qt5Network.dll %BUILD_OUTPUT_DIR%
copy %QT_LIB_DIR%\Qt5TextToSpeech.dll %BUILD_OUTPUT_DIR%
